...
namespace doancsn.Controllers
{
	public class Admin : Controller
	{
        ...
        public Admin(doancsnContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> DiscountsCreate([Bind("Id,Name,Amout,Code,StartDay,EndDay")] Discount discount)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> DiscountsEdit(int id, [Bind("Id,Name,Amout,Code,StartDay,EndDay")] Discount discount)
        {
            if (id != discount.Id)
            {
                return NotFound();
        ...
        [HttpPost]
        public async Task<IActionResult> ProductsIndex(int catid, string keywords)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Administrator")]
        public async Task<IActionResult> ProductsCreate([Bind("Id,Name,Description,ImageUrl,Price,NewPrice,Quantity,IsNew,IsBestSeller,IsSale,CategoryId,DiscountId")] Product product)
        {
            if (ModelState.IsValid)
            {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Administrator")]
        public async Task<IActionResult> ProductsEdit(int id, [Bind("Id,Name,Description,ImageUrl,Price,NewPrice,Quantity,IsNew,IsBestSeller,IsSale,CategoryId,DiscountId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> UsersCreate([Bind("Id,Name,Email,Password,Role")] User user)
        {
            if (ModelState.IsValid)
            {
                _context.Add(user);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> UsersEdit(int id, [Bind("Id,Name,Email,Password,Role")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
